  ...
  app.post("/api/public/visitor-registration", async (req, res) => {
    try {
      ...
      const visitorData = {
        ...
        otherPurpose: validatedData.purposeOfVisit === 'other' ? validatedData.otherPurpose : null,
        details: validatedData.purposeOfVisit === 'other' ? validatedData.otherPurpose : validatedData.purposeOfVisit,
